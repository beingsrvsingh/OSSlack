using AstrologerMicroservice.Application;
...
namespace AstrologerMicroservice.Infrastructure
{
    public static class InfrastructureServiceRegistration
    {
        public static IServiceCollection AddInfrastructureServices(this IServiceCollection services)
        {
            ...
            services.AddDbContext<AstrologerDbContext>(options =>
        ...
        {
            var dbContextOptions = serviceProvider.GetRequiredService<DbContextOptions<AstrologerDbContext>>();

            using (var dbContext = new AstrologerDbContext(dbContextOptions))
            {
