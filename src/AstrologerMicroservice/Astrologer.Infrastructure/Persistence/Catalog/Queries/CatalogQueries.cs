...
namespace Astrologer.Infrastructure.Persistence.Catalog.Queries
{
    public class CatalogQueries
    {
        public static IQueryable<AstrologerMaster> ApplySearch(
        IQueryable<AstrologerMaster> query,
        string? search)
        {
        ...
        public static readonly Expression<Func<AstrologerMaster, CatalogResponseDto>> ToCatalogResponse =
