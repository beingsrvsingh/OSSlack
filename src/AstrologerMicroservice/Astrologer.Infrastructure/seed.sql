...
-- Kundli Type
(1, 101, 6001, 7001, 'Janma Kundli', 'kundli_type', 'Kundli Type', 4, 401, CURRENT_TIMESTAMP(6)),
(2, 102, 6001, 7002, 'Nadi Kundli', 'kundli_type', 'Kundli Type', 4, 401, CURRENT_TIMESTAMP(6)),
(3, 103, 6001, 7003, 'Prashna Kundli', 'kundli_type', 'Kundli Type', 4, 401, CURRENT_TIMESTAMP(6)),

-- Languages Spoken
(4, 101, 6002, 7004, 'Hindi', 'language', 'Language', 4, 402, CURRENT_TIMESTAMP(6)),
(5, 101, 6002, 7005, 'English', 'language', 'Language', 4, 402, CURRENT_TIMESTAMP(6)),
(6, 102, 6002, 7006, 'English', 'language', 'Language', 4, 402, CURRENT_TIMESTAMP(6)),
(7, 103, 6002, 7007, 'Sanskrit', 'language', 'Language', 4, 402, CURRENT_TIMESTAMP(6)),

-- Certification
(8, 101, 6003, 7008, 'Certified Vedic Astrologer', 'certification', 'Certification', 1, 403, CURRENT_TIMESTAMP(6)),
(9, 103, 6003, 7009, 'Numerology Expert', 'certification', 'Certification', 1, 403, CURRENT_TIMESTAMP(6)),

-- Specializations
(10, 101, 6004, 7010, 'Birth Chart Analysis', 'specializations', 'Specializations', 4, 404, CURRENT_TIMESTAMP(6)),
(11, 102, 6004, 7011, 'Numerology Reading', 'specializations', 'Specializations', 4, 404, CURRENT_TIMESTAMP(6)),
(12, 103, 6004, 7012, 'Marriage Matching', 'specializations', 'Specializations', 4, 404, CURRENT_TIMESTAMP(6));
...
INSERT INTO time_slots (id, astrologer_id, start_utc, end_utc, is_booked) VALUES
(1, 101, '2025-09-10 09:00:00', '2025-09-10 09:30:00', false),
(2, 101, '2025-09-10 09:30:00', '2025-09-10 10:00:00', true),
(3, 101, '2025-09-10 10:00:00', '2025-09-10 10:30:00', false),
(4, 102, '2025-09-11 14:00:00', '2025-09-11 14:30:00', false),
(5, 102, '2025-09-11 14:30:00', '2025-09-11 15:00:00', false);
