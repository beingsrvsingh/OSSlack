...
namespace Pooja.Infrastructure.Persistence.Catalog.Queries
{
    public class CatalogQueries
    {
        public static IQueryable<PoojaMaster> ApplySearch(
        IQueryable<PoojaMaster> query,
        string? search)
        {
        ...
        public static readonly Expression<Func<PoojaMaster, CatalogResponseDto>> ToCatalogResponse =
