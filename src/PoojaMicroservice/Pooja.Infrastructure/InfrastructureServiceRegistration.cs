...
namespace Pooja.Infrastructure
{
    public static class InfrastructureServiceRegistration
    {
        public static IServiceCollection AddInfrastructureServices(this IServiceCollection services)
        {
            ...
            services.AddDbContext<PoojaDbContext>(options =>
        ...
        {
            var dbContextOptions = serviceProvider.GetRequiredService<DbContextOptions<PoojaDbContext>>();

            using (var dbContext = new PoojaDbContext(dbContextOptions))
            {
