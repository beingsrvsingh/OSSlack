...
{
    public class GetSearchTemplesQueryHandler : IRequestHandler<GetSearchTemplesQuery, Result>
    {
        private readonly ILoggerService<GetSearchTemplesQueryHandler> _logger;
        private readonly ITempleService astrolgoerService;

        public GetSearchTemplesQueryHandler(ILoggerService<GetSearchTemplesQueryHandler> logger, ITempleService astrolgoerService)
        {
            this._logger = logger;
            this.astrolgoerService = astrolgoerService;
        }

        public async Task<Result> Handle(GetSearchTemplesQuery request, CancellationToken cancellationToken)
        {
