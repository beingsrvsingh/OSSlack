...
namespace Temple.Infrastructure.Persistence.Catalog.Queries
{
    public class CatalogQueries
    {
        public static IQueryable<TempleMaster> ApplySearch(
        IQueryable<TempleMaster> query,
        string? search)
        {
        ...
        public static readonly Expression<Func<TempleMaster, CatalogResponseDto>> ToCatalogResponse =
