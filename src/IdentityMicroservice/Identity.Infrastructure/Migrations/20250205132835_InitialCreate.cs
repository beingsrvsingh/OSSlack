    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUserAddresses", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AspNetUserAuditLogs",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUserAuditLogs", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AspNetUserDevices",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUserDevices", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUserRefreshTokens", x => x.UserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlphaTwoCode = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: false),
                    Emoji = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
                    Unicode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetMembership", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AspNetMembership_AspNetRoles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                name: "AspNetUserInfos",
                columns: table => new
                {
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FirstName = table.Column<string>(type: "nvarchar(100)", nullable: true),
                    LastName = table.Column<string>(type: "nvarchar(100)", nullable: true),
                    AvatarURI = table.Column<string>(type: "nvarchar(500)", nullable: true),
                    IsMembership = table.Column<bool>(type: "bit", nullable: false),
                    MembershipId = table.Column<string>(type: "nvarchar(256)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUserInfos", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_AspNetUserInfos_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetMembership_RoleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserAuditLogs_TableId",
                table: "AspNetUserAuditLogs",
                column: "TableId")
                .Annotation("SqlServer:Clustered", false);

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserAuditLogs_TableName",
                table: "AspNetUserAuditLogs",
                column: "TableName")
                .Annotation("SqlServer:Clustered", false);

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserAuditLogs_UserId",
                table: "AspNetUserAuditLogs",
                column: "UserId")
                .Annotation("SqlServer:Clustered", false);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserInfos_UserId",
                table: "AspNetUserInfos",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CityMaster_Pincode_DistrictName",
                table: "CityMaster",
                columns: new[] { "Pincode", "DistrictName" });
