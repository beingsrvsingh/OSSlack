using CartMicroservice.Application;
...
namespace CartMicroservice.Infrastructure
{
    public static class InfrastructureServiceRegistration
    {
        ...
        {
            var dbContextOptions = serviceProvider.GetRequiredService<DbContextOptions<CartDbContext>>();

            using (var dbContext = new CartDbContext(dbContextOptions))
            {
