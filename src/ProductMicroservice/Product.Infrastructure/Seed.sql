...
VALUES  
(1, 'iPhone 14', 'https://picsum.photos/seed/picsum/200/300', TRUE, 5, 120, 1, 3, 'Electronics', 'Mobile Phones', 'INR', 79900, 89900, 0, 18, NOW(), NULL, TRUE, TRUE, NOW(), NOW()),  
(2, 'Cargo Jeans', 'https://picsum.photos/seed/picsum/200/300', TRUE, 4, 80, 102, 7, 'Clothing', 'Men', 'INR', 1999, 2499, 20, 5, NOW(), NULL, FALSE, TRUE, NOW(), NOW()),  
(3, 'Yoga Mat', 'https://picsum.photos/seed/picsum/200/300', TRUE, 4, 45, 103, 10, 'Fitness', 'Equipment', 'INR', 1200, 1500, 10, 5, NOW(), NULL, FALSE, FALSE, NOW(), NOW()),  
