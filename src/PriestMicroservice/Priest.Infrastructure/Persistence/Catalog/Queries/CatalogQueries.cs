...
namespace Priest.Infrastructure.Persistence.Catalog.Queries
{
    public class CatalogQueries
    {
        public static IQueryable<PriestMaster> ApplySearch(
        IQueryable<PriestMaster> query,
        string? search)
        {
        ...
        public static readonly Expression<Func<PriestMaster, CatalogResponseDto>> ToCatalogResponse =
