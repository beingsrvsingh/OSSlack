...
{
    public class PriestMediaConfiguration : IEntityTypeConfiguration<PriestMedia>
    {
        public void Configure(EntityTypeBuilder<PriestMedia> entity)
        {
            entity.ToTable("priest_media");
            ...
            entity.Property(p => p.IsThumbnailUrl).HasColumnName("is_thumbnail_url").HasDefaultValue(true);
