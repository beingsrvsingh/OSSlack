...
namespace Priest.Infrastructure
{
    public static class InfrastructureServiceRegistration
    {
        public static IServiceCollection AddInfrastructureServices(this IServiceCollection services)
        {
            ...
            services.AddDbContext<PriestDbContext>(options =>
        ...
        {
            var dbContextOptions = serviceProvider.GetRequiredService<DbContextOptions<PriestDbContext>>();

            using (var dbContext = new PriestDbContext(dbContextOptions))
            {
