...
/// </summary>
public class ResultObject : ActionResult, IStatusCodeActionResult
{
    ...
    {
        // Modified here to get desired result
        Value = value;
    ...
    {
        var executor = context.HttpContext.RequestServices.GetRequiredService<IActionResultExecutor<ResultObject>>();
