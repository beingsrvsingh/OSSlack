...
namespace Shared.Infrastructure.Health
{
    ...
    ILoggerService logger) : IHealthCheck
    {
            ...
            CancellationToken cancellationToken = default)
        {
            try
            {
                _logger.LogInfo("ConnectionString in DbHealthCheck is: {ConnectionString}", _connectionString);
            ...
            {
                _logger.LogCritical(exception, "The exception happened with connection string : {ConnectionString}", _connectionString);
