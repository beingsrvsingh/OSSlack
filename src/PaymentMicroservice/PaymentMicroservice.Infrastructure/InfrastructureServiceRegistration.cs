using PaymentMicroservice.Application;
...
namespace PaymentMicroservice.Infrastructure
{
    public static class InfrastructureServiceRegistration
    {
        ...
        {
            var dbContextOptions = serviceProvider.GetRequiredService<DbContextOptions<PaymentDbContext>>();

            using (var dbContext = new PaymentDbContext(dbContextOptions))
            {
