...
{
    public class PoojaKitItemLocalizedTextConfiguration : IEntityTypeConfiguration<PoojaKitItemLocalizedText>
    {
        public void Configure(EntityTypeBuilder<PoojaKitItemLocalizedText> builder)
        {
            builder.ToTable("pooja_kit_item_localized_text");
            ...
            builder.HasOne(l => l.PoojaKitItem)
